(function () {
    if (!(cc && cc.EditBoxComponnet)) {
        return;
    }

    var KeyboardReturnType = cc.EditBoxComponnet.KeyboardReturnType;
    var _p = cc.EditBoxComponnet._EditBoxImpl.prototype;
    ...
    cc.EditBoxComponnet.prototype.editBoxEditingDidBegan = function () {
        cc.Component.EventHandler.emitEvents(this.editingDidBegan, this);
        this.node.emit('editing-did-began', this);
    };

    cc.EditBoxComponnet.prototype.editBoxEditingDidEnded = function () {
        cc.Component.EventHandler.emitEvents(this.editingDidEnded, this);
        this.node.emit('editing-did-ended', this);
    };

    cc.EditBoxComponnet.prototype._updateStayOnTop = function () {
        // wx not support
    };
    ...
    _p.createInput = function () {
        ...
        var multiline = this._inputMode === cc.EditBoxComponnet.InputMode.ANY;
